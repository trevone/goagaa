...
const destroy = (id) => {
    router.visit( route('admin.campaigns.destroy', [id]), { method: 'delete' } )
}
</script>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
              <div class="flex items-center justify-end px-4 py-3  text-end sm:px-6 sm:rounded-bl-md sm:rounded-br-md">
                  ...
                  <Link href="/dmn/campaigns/create" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"> 
                    Create </Link>
                </div>
           ...
           <div v-for="d in data.data">
               <div class="flex items-center">
                   ...
                   <h2 class="ms-3 text-xl font-semibold text-gray-900">
                       <a @click.prevent ="goCampaigns" href="/dmn/campaigns">{{ d.name }}</a>
                   </h2>
               </div>
               ...
               <p class="mt-4 text-sm"> 
                    <Link 
                      ...
                      :href="route('admin.campaigns.edit', [d.id])"
                    >  
                       Manage 
                    ...
                    <Link 
                      ...
                      class="inline-flex items-center font-semibold text-indigo-700"
                      :href="route('admin.campaigns.destroy', [d.id])"
                    >  
                       Delete 
                       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="ms-1 w-5 h-5 fill-indigo-500">
                           <path fill-rule="evenodd" d="M5 10a.75.75 0 01.75-.75h6.638L10.23 7.29a.75.75 0 111.04-1.08l3.5 3.25a.75.75 0 010 1.08l-3.5 3.25a.75.75 0 11-1.04-1.08l2.158-1.96H5.75A.75.75 0 015 10z" clip-rule="evenodd" />
